...
import RencanaDanLaporan from './pages/RencanaDanLaporan/RencanaDanLaporan';
                    ...
                    <Switch>
                      ...
                      {/* <Route path="/:role/rencana-pelaksanaan-program">
                        <PrivateRoute
                          ...
                          component={RencanaDanLaporan}
                          setId={setId}
                          notif={notifs}
                        />
                      </Route> */}
                      <Route path="/:role/rencana-dan-laporan">
                        <PrivateRoute
                          exact
                          path="/:role/rencana-dan-laporan"
                          component={RencanaDanLaporan}
                          setId={setId}
                          notif={notifs}
                        />
