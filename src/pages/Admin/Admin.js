...
const Admin = (props) => {
  ...
  const { limit, page, nama, instansi, totalUser } = filter;
          ...
          <div className="input-dan-tajuk">
            ...
            >
              <button className="tambah-program">
                ...
                <p className="text-input-program">Input Admin</p>
              </button>
            </Link>
          </div>
            ...
            >
              <thead className="table-head-admin">
                <tr>
                  ...
                  <th
                    width={sidebar ? '195px' : '258px'}
                    className={user && user.role === 'super_admin' ? 'd-none' : ''}
                    style={{ transition: 'all 0.3s ease-in-out' }}
                  >
                    Instansi
                  </th>
                  <th
                    width={sidebar ? '196px' : '258px'}
                    style={{ transition: 'all 0.3s ease-in-out' }}
                  >
                    Nama Pengguna
                  </th>
