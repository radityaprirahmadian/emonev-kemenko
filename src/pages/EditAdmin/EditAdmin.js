...
const EditAdmin = (props) => {
  ...
  const updateUserData = async (formData) => {
    ...
    try {
      ...
      history.push(
        `/${userDetail && userDetail.role === 'owner' ? 'super-admin' : 'admin'}/kelola-admin`,
      );
  ...
  return (
    <Fragment>
      ...
      <div className="profile-page">
        <div className="tajuk-page">EDIT ADMIN</div>
        {loading ? (
                        ...
                        {!sidebar ? (
                          ...
                          <Fragment>
                            ...
                            <div className="data">
                              <label>Instansi</label>
                              <br />
                              <div className="persist" style={{ width: '466px' }}>
                                {nama_pendek}
                              </div>
                              <div className="button-lock">
                                <img
                  ...
                  <div className="col">
                    <div className="photo-profile-page">
                      ...
                      <Link
                        ...
                        }/kelola-profile-admin/${props.match.params.id}`}
                      >
                        <button style={{ pointer: 'none' }} className="button-submit-profile">
                          {' '}
                          BATAL
                        </button>
                      </Link>
