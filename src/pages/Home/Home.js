    ...
    <Fragment>
      ...
      <div className="home" style={{ margin: '0' }}>
        <div
          ...
          style={documents && documents.length === 0 ? { height: '8vh' } : {}}
        >
                        ...
                        >
                          ...
                          >
                            <span className="span-progress" style={{ borderRadius: '0px' }}>
                              <span className="progress" style={{ borderRadius: '0px' }}></span>
                            </span>
                          </div>
                          <div key={index}>
                    ...
                    documentLengthArr
                      ...
                      .map((gambar, index) => {
                        return (
                          <div
                            className={
                              index + 1 === parseInt(page) ? 'slider-mark1 active' : 'slider-mark1'
                            }
                          ></div>
                        );
                      })}
          ...
          <div className="image-landing">
            <Link to={{ pathname: 'http://revolusimental.id/' }} target="_blank">
              <img
                src={linkTerkait1}
                className="image-1"
                alt="gerakan nasional revolusi mental"
              ></img>
            </Link>
        ...
        <div className="home-section-2 center">
          <div className="container">
            <div className="d-flex justify-content-between mb-3">
              ...
              <select
                className="home-statistik-tahun"
                type="text"
                name="tahun"
