    ...
    useEffect(() => {
        if (instansiDetail) {
            ...
            if (instansiDetail.logo) {
                const mediaFileUrl = [
                    `https://api.simonev.revolusimental.go.id${instansiDetail.logo}`,
                ];
                const files = [];
                                ...
                                <Element id="instansi" name="instansi">
                                    ...
                                    >
                                        ...
                                        {isEditing ? (
                                            ...
                                            <div
                                                className="gnrm-navigation-button"
                                                style={{ textAlign: "right" }}
                                            >
                                                <Link
                                                    to="admin_form"
