...
const LupaPassword = (props) => {
    ...
    const cekToken = async () => {
        ...
        try {
            const res = await axios.get(
                "https://api.simonev.revolusimental.go.id/api/v1/auth",
                config
            );
    ...
    const { password, confirm, err, disable } = pass;
    ...
    const changePassword = async (formData) => {
        ...
        try {
            ...
            alert(
                res.data.message + "kata sandi anda , silahkan login kembali"
            );
            history.push("/login");
        } catch (err) {
                            ...
                            >
                                ...
                                >
                                    ...
                                    <img
                                        src={aset_1}
                                        alt="decoration 1"
                                        style={{ bottom: "23px", left: "16px" }}
                                    />
                                    <img
                                        src={aset_2}
                                        alt="decoration 2"
                                        style={{ top: "17px", right: "18px" }}
                                    />
                                    <img
                                        src={aset_3}
                                        alt="decoration 3"
                                ...
                                >
                                    ...
                                    <div className="body-ubah">
                                        <h1>
                                            Masukkan alamat email Anda yang
                                            terkait <br /> dengan akun Anda
                                        </h1>
                                        <form
                            ...
                            >
                                ...
                                >
                                    ...
                                    <div className="body-ubah">
                                        ...
                                        <h1>
                                            Silahkan mengisi kata sandi baru
                                            anda
                                        </h1>
