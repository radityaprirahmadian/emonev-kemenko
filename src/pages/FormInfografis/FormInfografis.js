...
const FormInfografis = (props) => {
  ...
  const { judul, deskripsi } = kabarGnrm;
  ...
  const onSubmit = async (event) => {
    ...
    try {
      ...
      setLoadingFalse();
      history.push(
        `/${userDetail && userDetail.role === 'owner' ? 'super-admin' : 'admin'}/kabar-gnrm`,
      );
    } catch (err) {
  ...
  const onEdit = async (event) => {
    ...
    if (media.length > 0) {
      ...
      formData.append('gambar', new File([null], 'blob'));
    }
  ...
  useEffect(() => {
    if (infografisDetail) {
      editDocument();
      setKabarGnrm({
        judul: infografisDetail.judul,
        deskripsi: infografisDetail.deskripsi,
      });
                ...
                <Fragment>
                  ...
                  >
                    <div className="form-infografis">
                      ...
                      <div className="div_lampiran">
                        ...
                        <input
                          ...
                          multiple
                        />
                        <h1 className="penjelasan_lampiran">
                          (Ukuran maksimal berkas 25MB, Gambar Potrait dengan skala 1:1)
                        </h1>
                      </div>
                      <div>
                    ...
                    <div className="admin-navigation-button" style={{ textAlign: 'right' }}>
                      {isEditing ? (
                        <button type="submit" className="unggah-infografis" onClick={onEdit}>
                          UNGGAH KABAR GNRM
                        </button>
                      ) : (
                        <button type="submit" className="unggah-infografis" onClick={onSubmit}>
                          UNGGAH KABAR GNRM
                        </button>
                      )}
                    </div>
