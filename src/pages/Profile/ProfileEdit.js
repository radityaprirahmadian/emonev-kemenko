...
const ProfileEdit = (props) => {
  ...
  const updateUserData = async (formData) => {
    ...
    try {
      ...
      if (isFoto) {
        ...
        history.push(
          `/${userDetail && userDetail.role === 'owner' ? 'super-admin' : 'admin'}/profile/${
            props.match.params.id
          }`,
        );
  ...
  const updateUserPhoto = async () => {
    ...
    if (foto.length > 0) {
      ...
      formData.append('foto', new File([null], 'blob'));
    }
                      ...
                      {!sidebar ? (
                        <Fragment>
                          ...
                          >
                            ...
                            <div className="data">
                              ...
                              <br />
                              <div className="persist" type="text">
                        ...
                        <Fragment>
                          <div
                            ...
                            style={
                              sidebar
                                ? { marginLeft: '188px', width: '466px' }
                                : { marginLeft: '0', width: '466px' }
                            }
                          >
                            ...
                            <div className="data" style={{ width: '466px' }}>
                              <label>Instansi</label>
                              <br />
                              <div className="persist" style={{ width: '466px' }} type="text">
                                {userDetail && userDetail.instansi.nama_pendek}
                              </div>
                              <div className="button-lock">
                                <img
                  ...
                  <div className="col">
                    <div className="photo-profile-page">
                      ...
                      <div className="photo-profile-container">
                        ...
                        <u>
                          <h1>
                            <label htmlFor="testing" className="upload_foto">
                              Ganti Foto
                            </label>
                          </h1>
                        </u>
                        <input
                          ...
                          style={{ height: '42px', marginLeft: '28px', width: '955px' }}
                      ...
                      <Link
                        ...
                        }/profile/${userDetail && userDetail._id}`}
                      >
                        <button type="submit" className="button-submit-profile">
                          {' '}
                          BATAL
                        </button>
                      </Link>
