...
const SideBarOff = (props) => {
    ...
    useEffect(() => {
        if (
            pathname !=
            `/admin/profile-instansi/${instansiDetail && instansiDetail._id}`
        ) {
            if (
                pathname !=
                `/admin/edit-profile-instansi/${
                    instansiDetail && instansiDetail._id
                }`
            ) {
                if (
            ...
            {hide ? (
                ...
                <div className="popup-check">
                    <div className="popup-check-instansi">
                        <div className="popup-check-instansi-title">
                            Profil Instansi Belum Lengkap
                        </div>{" "}
                        <br />
                        <div>
                        ...
                        >
                            <button className="button-to-instansi">
                                LENGKAPI PROFIL
                            </button>
                        </NavLink>
                    </div>
