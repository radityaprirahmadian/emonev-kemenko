                    ...
                    <div style={{position:'relative' , marginTop : '7px'}}>
                        {
                            ...
                            :
                                <Fragment>
                                    ...
                                    <img src={logo_kemenko} alt='user-logo' style={{width:'30px' , height: '30px'}} className="logo-notif"/>
                                </Fragment>
                        }
                    </div>
                </div>
                <div className='card-popup-body'>
                    {
                        ...
                        :
                            <Fragment>
                                <div className='card-popup-isi'><span style={{fontWeight:'700'}}>INFO SIMONEV GNRM</span> memberi pesan kepada anda</div><br/>
                            </Fragment>
                    }
