      ...
      <li className="kabar-mega-li" style={{ height: 'fit-content', borderRadius: '0' }}>
        {detail && props.kabar._id === detail._id ? (
          <div className="kabar-mega-div">
            ...
            <div className="kabar-mega-judul" onClick={(event) => onClick(event, props.kabar)}>
              {detail && detail.judul}
            </div>
            <br />
            <br />
            ...
            <div className="kabar-mega-deskripsi">
              {detail && detail.deskripsi.length > 150
                ? `${detail && detail.deskripsi.substr(0, 147)}...`
                : detail && detail.deskripsi}
            </div>
            <div className="kabar-mega-button" style={{ textAlign: 'center', width: '100%' }}>
              <button onClick={() => onLinkTo(props.kabar._id)} className="button-topbar">
                Baca Lebih Lanjut
              </button>
            </div>
          </div>
        ) : (
          <div className="kabar-acordion" onClick={(event) => onClick(event, props.kabar)}>
            {props.kabar.judul.length > 30
              ? `${props.kabar.judul.substr(0, 27)}...`
              : props.kabar.judul}
